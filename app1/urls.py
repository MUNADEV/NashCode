...
urlpatterns = [
    ...
    path('nashcode.com/guardar/<int:id>',views.guardar,name='guardar'),
    path('nashcode.com/desguardar/<int:id>',views.desguardar,name='desguardar'),
    path('nashcode.com/like/<int:id>',views.like,name='like'),
    path('nashcode.com/dislike/<int:id>',views.dislike,name='dislike'),
